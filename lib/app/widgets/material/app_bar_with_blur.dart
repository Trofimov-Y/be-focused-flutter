...
/// app bar, see [SliverAppBarWithBlur], which embeds an [AppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///  * [SliverAppBarWithBlur], which uses [AppBar] to provide a flexible app bar that
...
class AppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// changes the [AppBar]'s size. A [SliverAppBarWithBlur] in a [CustomScrollView]
  ...
  /// used by [SliverAppBarWithBlur] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  /// {@endtemplate}
...
class _AppBarState extends State<AppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.toolbarOpacity != 1.0) {
      final opacity =
          const Interval(0.25, 1, curve: Curves.fastOutSlowIn).transform(widget.toolbarOpacity);
      if (titleTextStyle?.color != null) {
        titleTextStyle =
            titleTextStyle!.copyWith(color: titleTextStyle.color!.withOpacity(opacity));
      }
      if (toolbarTextStyle?.color != null) {
        toolbarTextStyle =
            toolbarTextStyle!.copyWith(color: toolbarTextStyle.color!.withOpacity(opacity));
      }
    ...
    return Semantics(
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Material(
          ...
          surfaceTintColor:
              widget.surfaceTintColor ?? appBarTheme.surfaceTintColor ?? defaults.surfaceTintColor,
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    final double extraToolbarHeight =
        math.max(minExtent - _bottomHeight - topPadding - (toolbarHeight ?? kToolbarHeight), 0);
...
///
/// {@tool dartpad}
/// Here is an example of [SliverAppBarWithBlur] when using [stretch] and [onStretchTrigger].
///
...
///
/// {@tool dartpad}
/// This sample shows a [SliverAppBarWithBlur] and it's behavior when using the
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverAppBarWithBlur] into its
///    scrolling.
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class SliverAppBarWithBlur extends StatefulWidget {
  /// Creates a Material Design app bar that can be placed in a [CustomScrollView].
  const SliverAppBarWithBlur({
    super.key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  ///
  /// Returns a [SliverAppBarWithBlur] configured with appropriate defaults
  ...
  const SliverAppBarWithBlur.medium({
    super.key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  ///   * https://m3.material.io/components/top-app-bar/overview, the Material 3
  ///     app bar specification.
  const SliverAppBarWithBlur.large({
    super.key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  /// See also:
  ///
  ///  * [SliverAppBarWithBlur] for more animated examples of how this property changes the
  ...
  @override
  State<SliverAppBarWithBlur> createState() => _SliverAppBarWithBlurState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverAppBarWithBlurState extends State<SliverAppBarWithBlur> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SliverAppBarWithBlur oldWidget) {
...
class _AppBarDefaultsM3 extends AppBarTheme {
  ...
  @override
  IconThemeData? get iconTheme => IconThemeData(color: _colors.onSurface, size: 24);

  @override
  IconThemeData? get actionsIconTheme => IconThemeData(color: _colors.onSurfaceVariant, size: 24);
