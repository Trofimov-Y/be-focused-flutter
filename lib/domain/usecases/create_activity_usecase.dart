...
@Injectable()
final class CreateActivityUseCase {
  const CreateActivityUseCase(this._activitiesRepository);

  final ActivitiesRepository _activitiesRepository;

  TaskEither<Failure, void> call(Activity entity) => _activitiesRepository.create(entity);
}
